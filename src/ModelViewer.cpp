...
void ModelViewer::createLogicalDevice()
{
    ...
    {
        queueCreateInfos.emplace_back(vk::DeviceQueueCreateFlagBits{},
                                      queueFamily,
                                      1,
                                      &queuePriority,
                                      nullptr);
    ...
    vk::DeviceCreateInfo createInfo(
        {}, queueCreateInfos, {}, deviceExtensions, &deviceFeatures);
...
vk::SurfaceFormatKHR ModelViewer::chooseSwapSurfaceFormat(
...
vk::PresentModeKHR ModelViewer::chooseSwapPresentMode(
...
vk::Extent2D
    ModelViewer::chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& capabilities)
{
...
void ModelViewer::createImageViews()
{
    ...
    std::transform(swapChainImages.begin(),
                   swapChainImages.end(),
...
vk::ImageView ModelViewer::createImageView(vk::Image            image,
                                           vk::Format           format,
...
vk::Format
    ModelViewer::findSupportedFormat(const std::vector<vk::Format>& candidates,
...
void ModelViewer::createGraphicsPipeline()
{
    ...
    vk::PipelineColorBlendStateCreateInfo colorBlending(
        {}, vk::False, vk::LogicOp::eCopy, colorBlendAttachment, {0.f});
...
void ModelViewer::createImage(uint32_t                width,
                              uint32_t                height,
                              uint32_t                mipLevels,
...
uint32_t ModelViewer::findMemoryType(uint32_t                typeFilter,
                                     vk::MemoryPropertyFlags properties)
{
...
void ModelViewer::createDepthResources()
{
    ...
    createImage(swapChainExtent.width,
                ...
                depthImageMemory);
    depthImageView =
        createImageView(depthImage, depthFormat, vk::ImageAspectFlagBits::eDepth, 1);
}
...
void ModelViewer::createTextureImage()
{
    ...
    generateMipmaps(
        textureImage, vk::Format::eR8G8B8A8Srgb, texWidth, texHeight, mipLevels);

    device.destroyBuffer(stagingBuffer);
    device.freeMemory(stagingBufferMemory);
}

void ModelViewer::createBuffer(vk::DeviceSize          size,
...
void ModelViewer::transitionImageLayout(vk::Image       image,
                                        vk::Format      format,
...
void ModelViewer::copyBufferToImage(vk::Buffer buffer,
                                    vk::Image  image,
                                    uint32_t   width,
                                    uint32_t   height)
{
...
void ModelViewer::generateMipmaps(vk::Image  image,
...
void ModelViewer::copyBuffer(vk::Buffer     srcBuffer,
                             vk::Buffer     dstBuffer,
                             vk::DeviceSize size)
{
    vk::CommandBuffer commandBuffer = beginSingleTimeCommands();
...
void ModelViewer::createDescriptorSets()
{
    ...
    for (size_t i = 0; i != MAX_FRAMES_IN_FLIGHT; ++i)
    {
        ...
        vk::DescriptorImageInfo imageInfo{textureSampler,
                                          textureImageView,
...
void ModelViewer::drawFrame()
{
    ...
    vk::PresentInfoKHR presentInfo{
        renderFinishedSemaphores[currentFrame], swapChain, imageIndex, {}};
...
void ModelViewer::recordCommandBuffer(vk::CommandBuffer commandBuffer,
                                      uint32_t          imageIndex)
{
